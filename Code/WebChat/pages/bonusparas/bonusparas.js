...
Page({
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          // 删除
          wx.request({
            url: that.data.durl+'/api/Bos/BonusParam/DelBonusParam',
            data: {
  ...
  edit: function (e) {
    // console.log(e.target.id);
    var BonusParamId = e.currentTarget.id;
    wx.navigateTo({
  ...
  SelectParas: function () {
    ...
    wx.getStorage({
      ...
      success: function (resc) {
        wx.request({
          url: that.data.durl +'/api/Bos/BonusParam/GetAllBonusParam',
          data: {
            CompanyID: resc.data
          },
          method: "GET",
